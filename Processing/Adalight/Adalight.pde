...
static final int leds[][] = new int[][] {
  {0, 0, 51}, 
  {0, 0, 50}, {0, 0, 49}, {0, 0, 48}, {0, 0, 47}, {0, 0, 46}, {0, 0, 45}, {0, 0, 44}, 
  {0, 0, 43}, {0, 0, 42}, {0, 0, 41}, {0, 0, 40}, {0, 0, 39}, {0, 0, 38}, {0, 0, 37}, 
  {0, 0, 36}, {0, 0, 35}, {0, 0, 34}, {0, 0, 33}, {0, 0, 32}, {0, 0, 31}, {0, 0, 30}, 
  {0, 0, 29}, {0, 0, 28}, {0, 0, 27}, {0, 0, 26}, {0, 0, 25}, {0, 0, 24}, {0, 0, 23}, 
  {0, 0, 22}, {0, 0, 21}, {0, 0, 20}, {0, 0, 19}, {0, 0, 18}, {0, 0, 17}, {0, 0, 16}, 
  ...
  {0, 33, 0}, {0, 34, 0}, {0, 35, 0}, {0, 36, 0}, {0, 37, 0}, {0, 38, 0}, {0, 39, 0}, 
  {0, 40, 0}, {0, 41, 0}, {0, 42, 0}, {0, 43, 0}, {0, 44, 0}, {0, 45, 0}, {0, 46, 0}, 
  {0, 47, 0}, {0, 48, 0}, {0, 49, 0}, {0, 50, 0}, {0, 51, 0}, {0, 52, 0}, {0, 53, 0}, 
  {0, 54, 0}, {0, 55, 0}, {0, 56, 0}, {0, 57, 0}, {0, 58, 0}, {0, 59, 0}, {0, 60, 0}, 
  {0, 61, 0}, {0, 62, 0}, {0, 63, 0}, {0, 64, 0}, {0, 65, 0}, {0, 66, 0}, 
  // ----
  {0, 66, 0}, 
  {0, 66, 1}, {0, 66, 2}, {0, 66, 3}, {0, 66, 4}, {0, 66, 5}, {0, 66, 6}, {0, 66, 7}, 
  {0, 66, 8}, {0, 66, 9}, {0, 66, 10}, {0, 66, 11}, {0, 66, 12}, {0, 66, 13}, {0, 66, 14}, 
  {0, 66, 15}, {0, 66, 16}, {0, 66, 17}, {0, 66, 18}, {0, 66, 19}, {0, 66, 20}, {0, 66, 21}, 
  {0, 66, 22}, {0, 66, 23}, {0, 66, 24}, {0, 66, 25}, {0, 66, 26}, {0, 66, 27}, {0, 66, 28}, 
  {0, 66, 29}, {0, 66, 30}, {0, 66, 31}, {0, 66, 32}, {0, 66, 33}, {0, 66, 34}, {0, 66, 35}, 
  {0, 66, 36}, {0, 66, 37}, {0, 66, 38}, {0, 66, 39}, {0, 66, 40}, {0, 66, 41}, {0, 66, 42}, 
  {0, 66, 43}, {0, 66, 44}, {0, 66, 45}, {0, 66, 46}, {0, 66, 47}, {0, 66, 48}, {0, 66, 49}, 
  {0, 66, 50}, {0, 66, 51}, 
  // ----
  {0, 66, 51}, {0, 65, 51}, {0, 64, 51}, {0, 63, 51}, {0, 62, 51}, 
  {0, 61, 51}, {0, 60, 51}, {0, 59, 51}, {0, 58, 51}, {0, 57, 51}, {0, 56, 51}, {0, 55, 51}, 
  {0, 54, 51}, {0, 53, 51}, {0, 52, 51}, {0, 51, 51}, {0, 50, 51}, {0, 49, 51}, {0, 48, 51}, 
  {0, 47, 51}, {0, 46, 51}, {0, 45, 51}, {0, 44, 51}, {0, 43, 51}, {0, 42, 51}, {0, 41, 51}, 
  {0, 40, 51}, {0, 39, 51}, {0, 38, 51}, {0, 37, 51}, {0, 36, 51}, {0, 35, 51}, {0, 34, 51}, 
  {0, 33, 51}, {0, 32, 51}, {0, 31, 51}, {0, 30, 51}, {0, 29, 51}, {0, 28, 51}, {0, 27, 51}, 
  {0, 26, 51}, {0, 25, 51}, {0, 24, 51}, {0, 23, 51}, {0, 22, 51}, {0, 21, 51}, {0, 20, 51}, 
  {0, 19, 51}, {0, 18, 51}, {0, 17, 51}, {0, 16, 51}, {0, 15, 51}, {0, 14, 51}, {0, 13, 51}, 
  {0, 12, 51}, {0, 11, 51}, {0, 10, 51}, {0, 9, 51}, {0, 8, 51}, {0, 7, 51}, {0, 6, 51}, 
  {0, 5, 51}, {0, 4, 51}, {0, 3, 51}, {0, 2, 51}, {0, 1, 51}, {0, 0, 51}, 
...
void draw () {
  ...
  if ((t = second()) != prev) {
    println(frameRate); // How are we doing?    if ((t = second()) != prev) {
    prev = t;
  }
